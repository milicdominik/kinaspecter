...
abstract class GeneratorCommand extends Command
{
    ...
    protected function buildReplacements()
    {
        return [
            '{{layout}}' => $this->layout,
            '{{tableName}}' => $this->table, //mnozina, table name
            '{{modelName}}' => $this->name, //jednina sturdly
            ...
            '{{modelNamePluralLowerCase}}' => Str::camel($this->table),
            '{{modelNamePluralUpperCase}}' => ucfirst($this->table),
            '{{modelNameLowerCase}}' => Str::camel($this->name),
            //'{{modelRoute}}' => $this->options['route'] ?? Str::kebab(Str::plural($this->name)),
            '{{modelRoute}}' => $this->options['route'] ?? Str::kebab($this->table),
    ...
    protected function getJedninaInput()
    {
        return trim($this->argument('jednina'));
    }
    /*protected function getMnozinaInput()
    {
        return trim($this->argument('mnozina'));
    }*/
