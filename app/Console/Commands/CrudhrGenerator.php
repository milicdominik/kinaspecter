 ...
 */
class CrudhrGenerator extends \App\Console\GeneratorCommand
{
    /**
     * The name and signature of the console command.
     * name - MNOZINA (naziv tablice)
     * jednina - JEDNINA - naziv modela
     * @var string
     */
    protected $signature = 'make:crudhr
                            {name : Table name}
                            {jednina : Naziv modela jednina lowercase}
     ...
     * @var string
     */
    protected $description = 'Create bootstrap CRUD operations for HR lang';
    ...
    public function handle()
    {
        ...
        $this->jednina = $this->getJedninaInput();
    ...
    {
      return Str::studly($this->jednina);
