...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 col-xl-8">
              ...
              <div class="d-none d-md-block px-3">
                <h4 class="text-light">{{config('app.title')}}</h4>
                <h5 class="text-light">{{config('app.description')}}</h5>
              </div>
            </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <a href="#" id="modalconfirm_confirmbtn" class="confirm btn">Potvrdi</a>
    ...
    @if ($smsg = Session::get('error'))
      <script>$(function(){showToast('{{__t('Error')}}','{{ $smsg }}', 'red','topcenter')})</script>
    @endif
    @if ($smsg = Session::get('info'))
      <script>$(function(){showToast('{{__t('Information')}}','{{ $smsg }}', 'blue','topcenter')})</script>
    @endif
