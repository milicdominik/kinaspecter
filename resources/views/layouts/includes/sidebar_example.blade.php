...
<ul class="sidebar-nav">
  ...
  <li class="sidebar-item active">
    <a data-bs-target="#layouts" data-bs-toggle="collapse" class="sidebar-link">
      <i class="align-middle me-2 fas fa-fw fa-desktop"></i> <span class="align-middle">Layouts</span>
    </a>
    <ul id="layouts" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
      <li class="sidebar-item active"><a class="sidebar-link" href="layouts-sidebar-left.html">Left Sidebar</a></li>
